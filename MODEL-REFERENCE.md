...
> Model IDs verified live against the OpenRouter catalog on 2026-09-21. Prices are the package's original figures; re-verify prices and IDs quarterly (catalogs churn fast).
...
|-------|-------|-----------------|
| `gemmafree` | Gemma 4 31B Free | `/model gemmafree` |
| `devfree` | Qwen3.8 27B Free | `/model devfree` |
| `glm` | GLM 5.2 Free | `/model glm` |

### ¢ — Under $0.50 per million tokens

| Alias | Model | Input/Output | `/model` command |
|-------|-------|-------------|-----------------|
| `devstral` | Devstral 2512 (paid) | $0.05/$0.22 | `/model devstral` |
| `flashlite` | Gemini 2.5 Flash-Lite | $0.10/$0.40 | `/model flashlite` |
| `deepseek` | DeepSeek V3 | $0.14/$0.28 | `/model deepseek` |
| `qwen3` | Qwen3.8 Max | $0.14/$0.28 | `/model qwen3` |
| `flash` | Gemini 2.5 Flash | $0.15/$0.60 | `/model flash` |
| `seed` | Seed 2.0 Code | $0.20/$0.60 | `/model seed` |
...
| `grok4` | Grok 4.7 | $2.00/$10.00 | `/model grok4` |
| `grokfast` | Grok 4.6 | $2.00/$10.00 | `/model grokfast` |
| `sonnet` | Claude Sonnet 5 | $3.00/$15.00 | `/model sonnet` |

### $$$ — $15+ per million tokens

| Alias | Model | Input/Output | `/model` command |
|-------|-------|-------------|-----------------|
| `opus46` | Claude Opus 5 | $15.00/$75.00 | `/model opus46` |
...
| 7 | `ultra-budget` | Tight budget | gemmafree ⚠️ | deepseek | kimi25 |
| 8 | `free-tier` | $0 only | gemmafree ⚠️ | devfree ⚠️ | glm ⚠️ |
...
- **Biggest context:** `/model gem3pro` — large context window
