...
name: cost-optimizer
version: 1.1.0
description: Cut OpenRouter API costs 50-90% with cheap model aliases, task-based
  switching advice, presets, and a savings tracker.
tags:
- cost
- models
- openrouter
...
### 2. code-machine
```
openclaw models aliases add devfree openrouter/qwen/qwen3.8-27b:free && openclaw models aliases add minimax openrouter/minimax/minimax-m2.1 && openclaw models aliases add codex52 openrouter/openai/gpt-5.2-codex && openclaw models aliases add devstral openrouter/mistralai/devstral-2512
```
**Tiers:** Base=devfree (FREE ⚠️) | Work=minimax (¢¢) | Frontier=codex52 ($$$)

### 3. claude-diehards
```
openclaw models aliases add haiku openrouter/anthropic/claude-haiku-4.5 && openclaw models aliases add sonnet openrouter/anthropic/claude-sonnet-5 && openclaw models aliases add opus46 openrouter/anthropic/claude-opus-5
```
**Tiers:** Base=haiku ($$) | Work=sonnet ($$$) | Frontier=opus46 ($$$)

### 4. big-context
```
openclaw models aliases add flash openrouter/google/gemini-2.5-flash && openclaw models aliases add grokfast openrouter/x-ai/grok-4.6 && openclaw models aliases add gem3pro openrouter/google/gemini-3.1-pro-preview
```
...
### 6. tool-master
```
openclaw models aliases add gem3flash openrouter/google/gemini-3.8-flash && openclaw models aliases add kimi25 openrouter/moonshotai/kimi-k2.5 && openclaw models aliases add gpt52 openrouter/openai/gpt-5.2
```
**Tiers:** Base=gem3flash (¢) | Work=kimi25 (¢¢) | Frontier=gpt52 ($$$)

### 7. ultra-budget
```
openclaw models aliases add gemmafree openrouter/google/gemma-4-31b-it:free && openclaw models aliases add deepseek openrouter/deepseek/deepseek-chat-v3-0324 && openclaw models aliases add kimi25 openrouter/moonshotai/kimi-k2.5 && openclaw models aliases add devfree openrouter/qwen/qwen3.8-27b:free
```
**Tiers:** Base=gemmafree (FREE ⚠️) | Work=deepseek (¢) | Frontier=kimi25 (¢¢)

### 8. free-tier
```
openclaw models aliases add gemmafree openrouter/google/gemma-4-31b-it:free && openclaw models aliases add devfree openrouter/qwen/qwen3.8-27b:free && openclaw models aliases add glm openrouter/z-ai/glm-5.2:free
```
**Tiers:** Base=gemmafree (FREE ⚠️) | Work=devfree (FREE ⚠️) | Frontier=glm (FREE ⚠️)
...
| `big-context` | $$ | Flash `/model flash` | Grok 4.6 `/model grokfast` | Gemini 3.1 Pro `/model gem3pro` |
...
| Preset | Cost | Base | Work | Frontier |
|--------|------|------|------|----------|
| `ultra-budget` | ¢ | Gemma Free `/model gemmafree` ⚠️ | DeepSeek `/model deepseek` | Kimi K2.5 `/model kimi25` |
| `free-tier` | FREE | Gemma `/model gemmafree` ⚠️ | Qwen Free `/model devfree` ⚠️ | GLM `/model glm` ⚠️ |
...
── BASE (for simple tasks, questions, chat) ──────
 ...
 e. devstral    — Devstral 2512            $0.05/$0.22   Cheapest paid
 f. deepseek    — DeepSeek V3              $0.14/$0.28   Cheap + strong
 g. gemmafree   — Gemma 4 31B Free      FREE ⚠️       Unreliable
 h. devfree     — Qwen3.8 27B Free       FREE ⚠️       Unreliable
...
── WORK (for coding, writing, daily tasks) ────────
 ...
 e. grokfast    — Grok 4.6        $2.00/$10.00  xAI fast tier
 f. seed        — Seed 2.0 Code         $0.20/$0.60   Long-context coder
 g. qwen3       — Qwen3.8 Max              $0.14/$0.28   Strong reasoning
 h. devstral    — Devstral 2512           $0.05/$0.22   Reliable Mistral
...
── FRONTIER (for complex architecture, security, multi-file) ──
 ...
 f. gem3pro     — Gemini 3.1 Pro         $1.25/$10.00   1M context
 g. grok4       — Grok 4.7                 $2.00/$10.00   Strong reasoning
...
**BASE menu:** a→flashlite, b→flash, c→mini, d→gem3flash, e→devstral, f→deepseek, g→gemmafree, h→devfree
...
| `devstral` | Devstral 2512 | `openrouter/mistralai/devstral-2512` | $0.05/$0.22 | Paid Devstral — reliable |
...
| `grokfast` | Grok 4.6 | `openrouter/x-ai/grok-4.6` | $2.00/$10.00 | xAI fast tier |
| `seed` | Seed 2.0 Code | `openrouter/bytedance-seed/seed-2.0-code` | $0.20/$0.60 | Long-context coder |
| `qwen3` | Qwen3.8 Max | `openrouter/qwen/qwen3.8-max-0902` | $0.14/$0.28 | Strong reasoning |
...
| `sonnet` | Claude Sonnet 4.5 | `openrouter/anthropic/claude-sonnet-5` | $3.00/$15.00 | Anthropic's workhorse |
...
| `opus46` | Claude Opus 4.6 | `openrouter/anthropic/claude-opus-5` | $15.00/$75.00 | Most powerful, most expensive |
| `gem3pro` | Gemini 3.1 Pro | `openrouter/google/gemini-3.1-pro-preview` | $1.25/$10.00 | 1M context |
| `grok4` | Grok 4.7 | `openrouter/x-ai/grok-4.7` | $2.00/$10.00 | Strong reasoning |
...
|-------|---------------|---------------------|-------|
| Gemma 3 27B | `openrouter/google/gemma-4-31b-it` | $0.10/$0.20 | Small, fast |
...
| Claude Opus 4 | `openrouter/anthropic/claude-opus-5` | $15.00/$75.00 | Previous Opus |
